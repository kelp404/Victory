...
;
(function(){var s,__indexOf=[].indexOf||function(item){for(var i=0,l=this.length;i<l;i++)if(i in this&&this[i]===item)return i;return-1};s=angular.module("victory.service",[]);s.service("$victory",function($http,$rootScope){var application,common,document,pageSize,setting,stupidBrowser,user_agent;if(sessionStorage.selectedApplication)$rootScope.selectedApplication=JSON.parse(sessionStorage.selectedApplication);$rootScope.user=victory.user;pageSize=20;user_agent=navigator.userAgent.toLowerCase();stupidBrowser=
