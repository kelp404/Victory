...
;
(function(){window.victory={test:""}}).call(this);
;
(function(){var a;a=function(b,a){return b.something=a};angular.module("victoryAngular",["ui.state"]).config(function(b){b.state("route1",{url:"/route1",templateUrl:"/views/login.html",controller:a});return b.state("index",{url:"",templateUrl:"/views/login.html",controller:a})})}).call(this);
;
...
return!1})};return a}();g=function(){function a(){this.click_document_group()}a.prototype.click_document_group=function(){return $(document).on("click","tr.document_group",function(){core.ajax({href:$(this).attr("href")},!0);return!1})};return a}();d=function(){return function(){new f;new h;new k;new e;new g}}();$(function(){core.setup();new d;return core.after_page_loaded()})}).call(this);
;
